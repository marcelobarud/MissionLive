...
import { GoalsService, MAX_GOAL_PHOTO_BYTES } from './goals.service';
...
export class GoalsController {
  ...
  @Post(':goalId/photos') @UseInterceptors(singleImageUploadInterceptor(MAX_GOAL_PHOTO_BYTES)) addPhoto(@Req() req: AuthenticatedRequest, @Param('goalId') goalId: string, @Body() dto: CreateGoalPhotoDto, @UploadedFile() file: Express.Multer.File) { return this.goals.addPhoto(req.user.id, goalId, dto, file); }
