...
export type Reminder = { id: string; creatorUserId: string; targetUserId: string; goalId: string; goalStepId?: string | null; remindAt: string; timezone: string; status: string; creator?: Pick<User, 'id' | 'name' | 'avatarUrl'>; target?: Pick<User, 'id' | 'name' | 'avatarUrl'>; goalStep?: { id: string; title: string } | null; goal?: { id: string; name: string; status: string; endDate?: string | null } };
...
export const api = {
  ...
  createReminder: (body: { goalId: string; targetUserId?: string; goalStepId?: string; remindAt: string; timezone: string }) => request<Reminder>('/reminders', json(body)),
